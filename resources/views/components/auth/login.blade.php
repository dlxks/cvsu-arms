...
<x-layouts.guests>
    <div class="my-4 flex flex-col gap-1 items-center justify-center">
        <!-- CvSU Icon -->
        <img src="{{ asset('images/CvSU-Logo.png') }}" alt="CvSU Icon" class="w-20">

        <!-- App Name -->
        <h1 class="text-xl font-medium text-center text-zinc-900 dark:text-zinc-100">{{ config('app.name') }}</h1>
